...
function init_gear_sets()
    ...
    -- maximize Rapid Shot and Snapsot
    -- preshot
    sets.precast.RA = {
        ammo=gear.RAbullet,
        head="Ikenga's Hat", --Snap+6
        body="Ikenga's Vest", --Snap+9
        hands="Ikenga's Gloves", --Sanp+7
        -- back="Navarch's Mantle",
        -- waist="Impulse Belt",
        legs="Ikenga's Trousers", --Snap+5
        feet="Ikenga's Clogs", --Snap+5
    }
    ...
    sets.precast.WS = sets.precast.RangedWS
